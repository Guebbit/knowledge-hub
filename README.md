...
`2repo` is a sibling command to `2brain`, focused on understanding repositories and injecting deterministic context for Claude, Copilot, and Cursor.

```
2repo /path/to/repo  →  graphify-out/* + REPO_CONTEXT.md + editor injections
```
